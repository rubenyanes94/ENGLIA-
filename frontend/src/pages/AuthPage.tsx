  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      if (mode === "login") {
        ...
        // Paso 2: pagar. La cuenta ya existe (cada pago va a nombre de
        // alguien), pero sin pagar no se entra a la app: ProtectedRoute
        // devuelve aquí a quien lo intente por cualquier otro camino.
